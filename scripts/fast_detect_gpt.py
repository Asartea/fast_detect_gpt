...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_file",
        type=str,
        default="./exp_test/results/xsum_gpt-4.falcon-7b_falcon-7b-instruct",
    )  # output file prefix
    parser.add_argument("--dataset", type=str, default="xsum")
    parser.add_argument(
        "--dataset_file", type=str, default="./exp_test/data/xsum_falcon-7b"
    )
